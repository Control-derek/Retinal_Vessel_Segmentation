...
def data_process(data_path, name, patch_size, stride, mode):
    ...
    if name == "DRIVE":
        ...
        img_path = os.path.join(data_path, mode, "image_orishape_enhanced")
        gt_path = os.path.join(data_path, mode, "label_orishape_enhanced")
    ...
    for i, file in enumerate(file_list):
        if name == "DRIVE":
            ...
            gt = Image.open(os.path.join(gt_path, file[:-4]+".gif"))
