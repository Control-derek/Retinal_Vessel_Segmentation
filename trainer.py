...
class Trainer:
    def __init__(self, model, CFG=None, loss=None, train_loader=None, val_loader=None, finetune=False, checkpoint=None):
        self.CFG = CFG
    ...
    def _train_epoch(self, epoch):
        ...
        for img, gt in tbar:
            ...
            # print(img)
            # print(gt)
            # save_path = "DRIVE_img.txt"
            # np_data = img.cpu().numpy()
            # np.savetxt(save_path, np_data)
            # save_path = "DRIVE_gt.txt"
            # np_data = gt.cpu().numpy()
            # np.savetxt(save_path, np_data)
            # exit()
